...
// Add this script to the <head> section of your HTML or an external JS file
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    window.addEventListener("click", function(event) {
      if (!event.target.matches("#languagesDropdown")) {
        if (languagesMenu.classList.contains("show")) {
